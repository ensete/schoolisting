...
<div class="panel panel-default" style="margin: 100px auto; width: 90%">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo LocalizedString("Change Password") ?> - <?php echo $school['school_name'] ?></h3>
    </div><!-- /panel-heading -->
        ...
        <form role="form" class="form-horizontal form-bordered" action="" method="post">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="current_pass"><?php echo LocalizedString("Current Password") ?><br>
                    <small><i style="color: red"><?php echo ($error = $this->session->flashdata('error_pass')) ? LocalizedString($error) : "" ?></i></small>
                </label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="password"><?php echo LocalizedString("New Password") ?><br>
                    <small><i style="color: red"><?php echo ($error = $this->session->flashdata('error_new')) ? LocalizedString($error) : "" ?></i></small>
                </label>
                <div class="col-sm-5">
                    <div class="input-group input-group-in">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="confirm_pass"><?php echo LocalizedString("Confirm Password") ?><br>
                    <small><i style="color: red"><?php echo ($error = $this->session->flashdata('error_match')) ? LocalizedString($error) : "" ?></i></small>
                </label>
                <div class="col-sm-5">
                    <div class="input-group input-group-in">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span>
